...
class AlwaysReversibleTests(TestCase):
    def test_regular_reversed(self):
        ...
        self.assertEqual(
            reversed([1, 2, 3]).__class__, more.always_reversible([1, 2, 3]).__class__
        )
...
class AlwaysIterableTests(TestCase):
    ...
    def test_base_type(self):
        ...
        custom_actual = list(more.always_iterable(dict_obj, base_type=dict))
    ...
    def test_none(self):
        self.assertEqual(list(more.always_iterable(None)), [])
...
class SplitIntoTests(TestCase):
    ...
    def test_iterable_small_extra(self):
        iterable = [1, 2, 3, 4, 5, 6, 7]
        sizes = [2, 3, 4, 5]
        expected = [[1, 2], [3, 4, 5], [6, 7], []]
        actual = list(more.split_into(iterable, sizes))
...
class ValueChainTests(TestCase):
    ...
    def test_empty_lists(self):
        actual = list(more.value_chain(1, 2, [], [3, 4]))
        expected = [1, 2, 3, 4]
        self.assertEqual(actual, expected)
